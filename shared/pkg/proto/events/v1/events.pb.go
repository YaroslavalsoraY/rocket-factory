...
type OrderPaid struct {
	...
	// Способ оплаты (строкой, значение из `PaymentMethod`)
...
const file_events_v1_events_proto_rawDesc = "" +
	...
	"order_uuid\x18\x02 \x01(\tR\torderUuid\x12\x1b\n" +
	"\tuser_uuid\x18\x03 \x01(\tR\buserUuid\x12$\n" +
	"\x0ebuild_time_sec\x18\x04 \x01(\x03R\fbuildTimeSecBPZNgithub.com/YaroslavalsoraY/rocket-factory/shared/pkg/proto/events/v1;events_v1b\x06proto3"
