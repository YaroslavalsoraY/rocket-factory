...
// Структура, описывающая производителя детали
...
// Структура, описывающая размеры детали
...
// Структура, описывающая дополнительные данные детали
type Value struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x06weight\x18\x04 \x01(\x01R\x06weight\"\x9e\x01\n" +
	"\x05Value\x12#\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBVZTgithub.com/YaroslavalsoraY/rocket-factory/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	8,  // 4: inventory.v1.Part.dimensions:type_name -> inventory.v1.Dimensions
